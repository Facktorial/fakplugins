function(enable_doxygen)
  ...
  if(ENABLE_DOXYGEN)
    ...
    # set(DOXYGEN_EXCLUDE_PATTERNS */tests/* */vendor/* */build/* */cmake/* */docs/*)
    ...
    if (DOXYGEN_FOUND)
		...
		IF (LIFT_DOCS)
            execute_process(
                COMMAND ${CMAKE_COMMAND} -E remove_directory ${CMAKE_CURRENT_SOURCE_DIR}/build_docs
                RESULT_VARIABLE REMOVE_RESULT
            )
            execute_process(
                COMMAND ${CMAKE_COMMAND} -E copy_directory ${CMAKE_CURRENT_BINARY_DIR}/docs/html ${CMAKE_CURRENT_SOURCE_DIR}/build_docs
